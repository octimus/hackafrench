...
oyCrosswordPuzzle.prototype.init = function(){ 
	this.hlist = new oyClueList(this, "Horizontalement", this.hclues, "oygHClue", "H");
	this.vlist = new oyClueList(this, "Verticalement", this.vclues, "oygVClue", "V");
	
	var oThis = this;	
	  
	// document.getElementById("oygHeader").innerHTML = 
	// 	"<span class='oyHeaderTitle'>" + this.title + "</span><br><span class='oyHeaderDesc'>" + this.desc + " - Auteur : " + this.publisherName + "</span>";
	...
	buf += "<tr><td class='oyCopyright' colspan='2' align='center'></tr>";
	buf += "</table>"; 
